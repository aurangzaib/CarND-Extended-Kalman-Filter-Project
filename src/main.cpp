...
int main() {
  ...
  Tools tools;
  // estimations are obtained from EKF
  vector<VectorXd> estimations;
  // ground truth are obtained from simulator
        ...
        if (length && length > 2 && data[0] == '4' && data[1] == '2') {
          ...
          if (s != "") {
            ...
            if (event == "telemetry") {
              ...
              iss >> sensor_type;
              // LIDAR measurement
              // read px, py and timestamp from measurement string
              ...
              // RADAR measurement
              // read rho, phi, rho_dot and timestamp from measurement string
              ...
              // Evaluate estimations against ground truth
